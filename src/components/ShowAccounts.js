...
export default class ShowAccounts extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://ems-react-app-default-rtdb.firebaseio.com/accounts.json")
      .then((resp) => {
  ...
  removeAccount = (account) => {
    console.log(account);
    const url = `https://ems-react-app-default-rtdb.firebaseio.com/accounts/${account.id}.json`;
    axios
      .delete(url)
      .then((resp) => {
  ...
  update = () => {
    console.log(this.state);
    const url = `https://ems-react-app-default-rtdb.firebaseio.com/accounts/${this.state.id}.json`;
